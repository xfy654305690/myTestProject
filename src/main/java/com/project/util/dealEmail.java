...
public class dealEmail {
    ...
    //连接邮件，暂时先默认账号密码
    public static void ctreatMail(List<zj_Report_Public> zj_Report_Public, String username, String password,String title,String content,String enclosureAdress) throws MessagingException, IOException {
    ...
    public static void ctreatAttachMail(List<zj_Report_Public>zj_Report_Public,Session session,Transport ts,String title,String content,String enclosureAdress) throws MessagingException, IOException {
        ...
        for (int i=0;i<zj_Report_Public.size();i++){
            ...
            //收件人
            message.setRecipient(Message.RecipientType.TO, new InternetAddress(zj_Report_Public.get(i).getZj_Person_In_Charge_Email()));
            //邮件标题
