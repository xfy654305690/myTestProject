...
public class Myschedule {
    ...
    public static void main(String[] args) throws SchedulerException, InterruptedException {
        ...
        JobDetail jobDetailZcy1 = JobBuilder.newJob(DoJob2.class)
        ...
        CronTrigger cronTriggerZcy1 = TriggerBuilder.newTrigger().withIdentity("triggerZcy1", "triggerGroupZcy1")
                ...
                .startAt(startDate)
                //.withSchedule(CronScheduleBuilder.cronSchedule("0 0/2 * * * ? "))
                .withSchedule(CronScheduleBuilder.cronSchedule("0 35 16,19 * * ? *"))
                .build();

        //4、执行
        scheduler.scheduleJob(jobDetail, cronTrigger);
        scheduler.scheduleJob(jobDetailZss1, cronTriggerZss1);
        scheduler.scheduleJob(jobDetailZcy1, cronTriggerZcy1);
