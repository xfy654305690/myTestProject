...
public class zj_Report_Kd_Wg_Business {
    ...
    //读取EXCLE目录
    public static  final  String inExcleFile="C:\\Test\\KD_WG\\test.xlsx";
    //输出EXCLE目录
    public static  final  String OutExcleFile="C:\\Test\\KD_WG\\test.xlsx";
    //转化图片源文件
    public static  final  String inPictureFile="C:\\Test\\KD_WG\\test.xlsx";
    //图片地址跟目录
    public static  final  String OutPictureFile="C:\\test\\KD_WG\\PICTURE\\";
    //微信群名称
    public static  final  String wechartSendName="春季营销冲锋行动（鄞战2022）";
    public static  final  String wechartPictureAdress="C:\\test\\KD_WG\\";
    //微信群名称
    public static  final  String inExcleDataFile="C:\\Test\\KD_WG\\test.xlsx";
    //导出数据地址
    public static  final  String OutExcleDataFile="C:\\Test\\KD_WG\\DATA\\";
    //复制导出文件地址
    public static  final  String OutExcleSouceFile="C:\\Test\\KD_WG\\SOUCE\\";
    //到达备份名称
