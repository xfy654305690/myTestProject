...
public class zj_Report_Kd_Qz_Business {
    ...
    //取数导出excle
    public static void report_Kd_Qz_Zj_Js() throws IOException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, MessagingException, ParseException {
        ...
        List<zj_Report_Kd_Qz_Jz_Zj> selectZj_Report_Kd_Qz_List_Zj =
                zj_Report_Kd_QzDao.selectZj_Report_Kd_Qz_Jz_Zj_JS(tableNameOld,tableNameNew);
...
//        zj_Report_Kd_Qz_Cl_Zj Zj_Report_Kd_Qz_Cl_Zj=new zj_Report_Kd_Qz_Cl_Zj();
        ...
        //处理季度日期差
        Integer monthDay=dealTime.get_date_Difference_Values(dealTime.getLastQuarterFirstDay(),dealTime.getLastQuarterLastDay());
...
//        DealExcle.cpoyToExcleSingle(maxDateStringQzCl,inExcleFile,OutExcleFile, 9);
        ...
        //复制文件
        String OutExcleSouceFilenew =OutExcleAccountsFile_JS+"宽带千兆新增净增通报"+"_"+nowDayYYYYMMDD+".xlsx";
        DealExcle.copyExcleToOtherExcle(OutExcleFile,OutExcleSouceFilenew);

    }
    //取数导出excle
    public static void report_Kd_Qz_Zj() throws Exception {
...
//
//        List<zj_Report_Kd_Qz_Jz_Zj> selectZj_Report_Kd_Qz_List_Zj =
//                zj_Report_Kd_QzDao.selectZj_Report_Kd_Qz_Jz_Zj(tableNameNew,startDate,endDate);
//
//        List<zj_Report_Kd_Qz_New_Zj> selectZj_Report_Kd_Qz_New_List_Zj =
//                zj_Report_Kd_QzDao.selectZj_Report_Kd_Qz_New_Zj(startDate,endDate);
//
...
//        DealExcle.copyExcleToOtherExcle("D:\\Test\\Kd_Qz\\test_630.xlsx",OutExcleSouceFilenew);
//        System.out.println("复制文件成功成功");
...
//    }
    ...
    //取数导出excle
    public static void report_Kd_Qz_Zj_dangyue() throws Exception {
