...
public class zj_Report_Znzw_Business {
    ...
    //取数导出excle
    public static void report_Znzw_Zj_Js() throws IOException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, MessagingException, ParseException {
        ...
        //复制文件
        String OutExcleSouceFilenew =OutExcleAccountsFile_JS+"全屋wifi通报"+"_"+nowDayYYYYMMDD+".xlsx";
    ...
    public static void report_Znzw_Zj() throws Exception {
        ...
        String title ="全屋wifi通报"+nowDayYYYYMMDD+"详见附件";
        String content="全屋wifi通报"+nowDayYYYYMMDD+"详见附件";
    ...
    public static String report_Znzw_DoDetail_Context( List<zj_Report_Znzw_New_Zj> selectZj_Report_Znzw_New_List_Zj_Deal)  {
        ...
        context="鄞州全屋wifi整体新增共："+(int) Math.floor(heji.getZnzw_Amt())+",整体完成率："+nf.format(heji.getZnzw_Amt_Rate())+"。"+"\n"+"新增完成率后五支局："+
