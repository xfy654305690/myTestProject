...
public class zj_Report_OtherDone_Business {
    ...
    //取数导出excle
    public static void report_OtherDone_Zj() throws IOException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, MessagingException {
        ...
        //if (0>1){
            ...
            for (int i=0;i<zj_Report_Public_List.size();i++){
                ...
                List<zj_Report_OtherDone_Cdma_Data> zj_Report_OtherDone_Cdma_Data_List =
                        zj_Report_OtherDoneDao.selectZj_Report_OtherDone_Cdma_Data(endDate,zj_Report_Public_List.get(i).getZj_Abbr_Name());
                //Kd数据
                List<zj_Report_OtherDone_Kd_Data> zj_Report_OtherDone_Kd_Data_List =
                        zj_Report_OtherDoneDao.selectZj_Report_OtherDone_Kd_Data(endDate,zj_Report_Public_List.get(i).getZj_Abbr_Name());
                //Gt数据
                List<zj_Report_OtherDone_Gt_Data> zj_Report_OtherDone_Gt_Data_List =
                        zj_Report_OtherDoneDao.selectZj_Report_OtherDone_Gt_Data(endDate,zj_Report_Public_List.get(i).getZj_Abbr_Name());
                //Gt数据
                List<zj_Report_OtherDone_Zd_Data> zj_Report_OtherDone_Zd_Data_List =
                        zj_Report_OtherDoneDao.selectZj_Report_OtherDone_Zd_Data(endDate,zj_Report_Public_List.get(i).getZj_Abbr_Name());
                ...
                if(zj_Report_OtherDone_Cdma_Data_List.size()!=0){
                    ...
                    //处理时间
                    DealExcle.cpoyToExcleSingle("暂无CDMA数据",OutExcleDataFileNew,OutExcleDataFileNew, 0);
                }

                if(zj_Report_OtherDone_Kd_Data_List.size()!=0){
                    //复制值,并且另存为
                    DealExcle.cpoyToExcle(zj_Report_OtherDone_Kd_Data_List,null,OutExcleDataFileNew,1,zj_Report_OtherDone_Kd_Data);
                }else{
                    //处理时间
                ...
                if(zj_Report_OtherDone_Gt_Data_List.size()!=0){
                    //复制值,并且另存为
                    DealExcle.cpoyToExcle(zj_Report_OtherDone_Gt_Data_List,null,OutExcleDataFileNew,2,zj_Report_OtherDone_Gt_Data);
                }else{
                    //处理时间
                ...
                if(zj_Report_OtherDone_Zd_Data_List.size()!=0){
                    //复制值,并且另存为
                    DealExcle.cpoyToExcle(zj_Report_OtherDone_Zd_Data_List,null,OutExcleDataFileNew,3,zj_Report_OtherDone_Zd_Data);
                }else{
                    //处理时间
