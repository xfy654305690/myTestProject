...
import com.project.view.zj_Report_Kj_Dao;
...
public class zj_Report_Kj_Business {

    public static  final  String config="mybatis.xml";
    //读取EXCLE目录
    public static  final  String inExcleFile="D:\\Test\\KJ\\test.xlsx";
    //输出EXCLE目录
    public static  final  String OutExcleFile="D:\\Test\\KJ\\test.xlsx";
    //转化图片源文件
    public static  final  String inPictureFile="D:\\Test\\KJ\\test.xlsx";
    //图片地址跟目录
    public static  final  String OutPictureFile="D:\\test\\KJ\\PICTURE\\";
    //微信群名称
    public static  final  String wechartSendName="鄞战2022-冲刺630";
    public static  final  String wechartPictureAdress="D:\\test\\KJ\\";
    //微信群名称
    public static  final  String inExcleDataFile="D:\\Test\\KJ\\test.xlsx";
    //导出数据地址
    public static  final  String OutExcleDataFile="D:\\Test\\KJ\\DATA\\";
    //复制导出文件地址
    public static  final  String OutExcleSouceFile="D:\\Test\\KJ\\SOUCE\\";
    //复制结算文件地址
    public static  final  String OutExcleAccountsFile_JS="D:\\Test\\JS_ALL\\KJ\\";
    ...
    public static void report_Kj_Zj() throws IOException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, MessagingException, ParseException {
        ...
        //复制文件
        String OutExcleSouceFilenew =OutExcleSouceFile+"看家通报"+"_"+nowDayYYYYMMDD+".xlsx";
        DealExcle.copyExcleToOtherExcle(OutExcleFile,OutExcleSouceFilenew);
        ...
        String title ="看家通报"+nowDayYYYYMMDD+"详见附件";
        String content="看家通报"+nowDayYYYYMMDD+"详见附件";
    ...
    //新增处理
    public static List<zj_Report_Kj_New_Zj> report_Kj_New_DoDetail( List<zj_Report_Kj_New_Zj> Zj_Report_Kj_New_List_Zj,Integer differenceDay,Integer quarterDay)  {

        for(int i=0;i<Zj_Report_Kj_New_List_Zj.size();i++){
            //日均新增
            Zj_Report_Kj_New_List_Zj.get(i).setKj_Amt_Avg( (Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt()/differenceDay));
            //季度缺口
            Zj_Report_Kj_New_List_Zj.get(i).setKj_Amt_Gap((int) Math.ceil(Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt_Avg_Tar()*quarterDay-Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt()));
            //季度指标
            Zj_Report_Kj_New_List_Zj.get(i).setKj_Amt_Tar((int) Math.ceil(Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt_Avg_Tar() *quarterDay));
            //完成率
            if(((Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt()/differenceDay))/Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt_Avg_Tar()<=1.2){
                Zj_Report_Kj_New_List_Zj.get(i).setKj_Amt_Rate(((Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt()/differenceDay))/Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt_Avg_Tar());
            }
            if(((Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt()/differenceDay))/Zj_Report_Kj_New_List_Zj.get(i).getKj_Amt_Avg_Tar()>1.2){
                Zj_Report_Kj_New_List_Zj.get(i).setKj_Amt_Rate(1.2);
            }

        }
        return Zj_Report_Kj_New_List_Zj;
    }

    //新增处理
    public static String report_Kj_DoDetail_Context( List<zj_Report_Kj_New_Zj> selectZj_Report_Kj_New_List_Zj_Deal)  {

        zj_Report_Kj_New_Zj heji=selectZj_Report_Kj_New_List_Zj_Deal.get(selectZj_Report_Kj_New_List_Zj_Deal.size()-1);

        List<zj_Report_Kj_New_Zj> detailDone =selectZj_Report_Kj_New_List_Zj_Deal;
        detailDone.remove(selectZj_Report_Kj_New_List_Zj_Deal.size()-1);
        ...
        for(int i=0;i<detailDone.size()-1;i++){//外层循环控制排序趟数
            for(int j=0;j<detailDone.size()-1-i;j++){
                //内层循环控制每一趟排序多少次
                if(detailDone.get(j).getKj_Amt_Rate() > detailDone.get(j + 1).getKj_Amt_Rate()) {
                    zj_Report_Kj_New_Zj temp= detailDone.get(j);
        ...
        context="鄞州看家整体新增共："+(int) Math.floor(heji.getKj_Amt())+",整体完成率："+nf.format(heji.getKj_Amt_Rate())+"。"+"\n"+"新增完成率后五支局："+
